...
def produce_assembling_parameters(word_pair):
    ...
    w1_id = random.choice([im for im in os.listdir(w1_path) if (im.endswith(".png") or im.endswith(".jpg"))])
    w2_id = random.choice([im for im in os.listdir(w2_path) if (im.endswith(".png") or im.endswith(".jpg"))])
